...
// Fetch categories
$sql = "SELECT id, name, file_name FROM categories";
          ...
          <div class="offcanvas-body">
              <div class="order-md-last">
                  <h4 class="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <span id="cart-badge-offcanvas" class="badge bg-primary rounded-circle pt-2"></span>
                  </h4>
...
<div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0">
  ...
  <li class="nav-item">
    ...
    <li class="nav-item">
        <a href="register.php" class="nav-link fw-bold text-dark" target="_blank">Register</a>
    </li>
  <?php
  }
    ?>
              ...
              <div class="dropdown">
                <button class="btn">
                    <a href="#" class="btn-link"><span>Post & Add</span></a>
                </button>
                <div class="dropdown-content">
                    <a href="sell.php">Sell your Pets</a>
                 
                </div>
            </div>
              <button class="btn">
                <a href="appointment.php" class="btn-link"><span>Appoinment</span></a>
            </button> 
