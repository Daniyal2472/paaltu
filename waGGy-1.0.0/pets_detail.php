                        ...
                        <div class="mt-3" id="form1">
                            <div class="w-100 d-flex">
                                <div class="w-60">
                                    ...
                                    <p class="blue-color pt-2">Breed: <?php echo htmlspecialchars($row['breed']); ?></p>
                                    <p class="blue-color pt-2">Color: <?php echo htmlspecialchars($row['color']); ?></p>
                                    <p class="blue-color pt-2">Weight: <?php echo htmlspecialchars($row['weight']); ?></p>
                                    <p class="blue-color pt-2">Height: <?php echo htmlspecialchars($row['height']); ?></p>
                                    <p class="blue-color pt-2">Age: <?php echo htmlspecialchars($row['age']); ?></p>
                                    <p class="blue-color pt-2">Gender: <?php echo htmlspecialchars($row['gender']); ?></p>
                                    <p class="blue-color pt-2">Vaccination Status: <?php echo htmlspecialchars($row['vaccination_status']); ?></p>
                                    <p class="blue-color pt-2">Temperament: <?php echo htmlspecialchars($row['temperament']); ?></p>
                                    <p class="blue-color pt-2">Good with Children: <?php echo htmlspecialchars($row['good_with_children']); ?></p>
                                    <p class="blue-color pt-2">Good with Other Pets: <?php echo htmlspecialchars($row['good_with_other_pets']); ?></p>
                                </div>
                            </div>
                        </div>
