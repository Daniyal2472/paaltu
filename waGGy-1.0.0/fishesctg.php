          ...
          <div class="section-header d-md-flex justify-content-between align-items-center">
            ...
            <div class="mb-4 mb-md-0">
              <p class="m-0">
                ...
                <button class="filter-button me-4 " data-filter=".cat">FISHES 1</button>
                <button class="filter-button me-4 " data-filter=".dog">FISHES 2</button>
                <button class="filter-button me-4 " data-filter=".bird">FISHES 3</button>
              </p>
            </div>
            <div>
